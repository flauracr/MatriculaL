...
namespace CapaAD
{
    public class ProfesorAD
    {
        ...
        public int Modificar(EntidadProfesor pEntidadProfesor)
        {
            ...
            Sentencia = "UPDATE PROFESORES SET CEDULA_PROFESOR=@CedulaProfesor,NOMBRE_PROFESOR=@NombreProfesor,PRIMER_APELLIDO_P=@Apellido1Profesor, SEGUNDO_APELLIDO_P=@Apellido2Profesor,TELEFONO_PROFESOR=@TelefonoProfesor, CORREO_PROFESOR=@CorreoProfesor, FECHA_INGRESO_PROFESOR=@FechaIngreso_Profesor, ESTADO_PROFESOR=@EstadoProfesor" +
