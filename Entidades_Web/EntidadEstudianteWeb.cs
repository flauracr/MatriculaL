...
namespace Entidades_Web
{
    public class EntidadEstudianteWeb
    {
        //atrubutos
        ...
        public EntidadEstudianteWeb(int pid, string pcedula, string nombreEstudiante, string papellido1, string papellido2, string ptelefono,
